...
/// Implements the <see cref="System.IEquatable{Hexalith.Domain.Aggregates.Dimension}" />.
/// </summary>
...
/// <seealso cref="System.IEquatable{Hexalith.Domain.Aggregates.Dimension}" />
[DataContract]
public record Dimension(
    ...
    [property: DataMember] string? ReferenceAggregateId) : CommonEntityAggregate(PartitionId, OriginId, Id)
{
    /// <summary>
    /// Initializes a new instance of the <see cref="Dimension" /> class.
    /// </summary>
    /// <param name="mapped">The mapped.</param>
    public Dimension(ExternalSystemReferenceAdded mapped)
        : this(
...
#pragma warning disable CA1024 // Use properties where appropriate
    public static string GetAggregateName() => nameof(Dimension);
