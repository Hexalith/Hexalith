...
public abstract class ExternalSystemEvent : PartitionedEvent
{
    ...
    protected override string DefaultAggregateId()
        => Dimension.GetAggregateId(PartitionId, CompanyId, SystemId, ReferenceAggregateName, ExternalId);

    /// <inheritdoc/>
    protected override string DefaultAggregateName() => Dimension.GetAggregateName();
}