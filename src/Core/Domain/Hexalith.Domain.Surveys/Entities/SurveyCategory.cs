...
// ***********************************************************************
// <copyright file="SurveyCategory.cs" company="Fiveforty SAS Paris France">
...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="SurveyCategory"/> class.
    /// </summary>
    ...
    public SurveyCategory(SurveyRegistered customer)
        : this(
