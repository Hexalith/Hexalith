...
// ***********************************************************************
// <copyright file="SurveyCampaign.cs" company="Fiveforty SAS Paris France">
...
/// Implements the <see cref="System.IEquatable{Hexalith.Domain.Aggregates.Survey}" />.
/// </summary>
...
/// <seealso cref="System.IEquatable{Hexalith.Domain.Aggregates.Survey}" />
[DataContract]
    ...
    DateTimeOffset Date) : Aggregate
{
    ...
    public SurveyCampaign(SurveyRegistered customer)
        : this(
