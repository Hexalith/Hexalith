...
// ***********************************************************************
// <copyright file="PureMessage.cs" company="Fiveforty SAS Paris France">
...
[DataContract]
[Serializable]
[JsonConverter(typeof(PolymorphicJsonConverter<PureMessage>))]
[DebuggerDisplay("{AggregateName}/{AggregateId}/{TypeName}/v{MajorVersion}/{MinorVersion}")]
public record PureMessage : IMessage, IPolymorphicSerializable
{
    /// <summary>
