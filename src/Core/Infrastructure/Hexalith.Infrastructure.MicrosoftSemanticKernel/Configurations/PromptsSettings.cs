...
// ***********************************************************************
// <copyright file="PromptsSettings.cs" company="Fiveforty SAS Paris France">
...
/// </summary>
public class PromptsSettings : ISettings
{
    // Chat commands
    ...
    /// Contextual prompt excludes all the system commands and user intent.
    /// </summary>
    /// <value>The external information context weight.</value>
