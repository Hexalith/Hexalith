...
// ***********************************************************************
// <copyright file="KeyValueActor - Copy.cs" company="ITANEO">
...
public class KeyListActor : Actor, IKeyValueActor
{
    /// <summary>
    /// The is loaded.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="KeyListActor"/> class.
    /// </summary>
    /// <param name="host">The <see cref="ActorHost" /> that will host this actor instance.</param>
    public KeyListActor(ActorHost host)
