...
// ***********************************************************************
// <copyright file="SalesInvoiceConverterHelper.cs" company="Fiveforty SAS Paris France">
...
public static class SalesInvoiceConverterHelper
{
    ...
    public static Dictionary<string, (object? OldValue, object? NewValue)> GetChanges([NotNull] this SalesInvoiceBase customer, [NotNull] SalesInvoiceInformationChanged e)
    {
    ...
    /// <param name="e">The e.</param>
    /// <returns>System.Collections.Generic.Dictionary&lt;string, object?&gt;.</returns>
    public static Dictionary<string, (object? OldValue, object? NewValue)> GetChanges([NotNull] this SalesInvoiceV3 customer, [NotNull] SalesInvoiceInformationChanged e)
    {
        ArgumentNullException.ThrowIfNull(customer);
        ArgumentNullException.ThrowIfNull(e);
        Dictionary<string, (object?, object?)> changes = [];
    ...
    /// <returns>Hexalith.Application.Sales.Commands.ChangeSalesInvoiceInformation.</returns>
    public static ChangeSalesInvoiceInformation ToChangeSalesInvoiceCommand(
            ...
            DateTimeOffset? birthDate = null)
    {
        ...
        ChangeSalesInvoiceInformation changed = new(
            partitionId,
            companyId,
            originId,
            customerId,
    ...
    /// <param name="title">The title.</param>
    /// <param name="birthDate">The birth date.</param>
    /// <returns>Hexalith.Domain.Events.SalesInvoiceInformationChanged.</returns>
    public static SalesInvoiceInformationChanged ToSalesInvoiceChangedEvent(
        [NotNull] this SalesInvoiceV3 customer,
        string partitionId,
        string companyId,
        string originId,
        ...
        DateTimeOffset? birthDate = null)
    {
        ...
        ArgumentException.ThrowIfNullOrEmpty(customer.SalesInvoiceAccount);
        ArgumentException.ThrowIfNullOrEmpty(customer.OrganizationName);
        SalesInvoiceInformationChanged changed = new(
            partitionId,
            companyId,
            originId,
            customerId,
    ...
    /// <param name="title">The title.</param>
    /// <param name="birthDate">The birth date.</param>
    /// <returns>Hexalith.Domain.Events.SalesInvoiceRegistered.</returns>
    public static SalesInvoiceRegistered ToSalesInvoiceRegisteredEvent(
        [NotNull] this SalesInvoiceV3 customer,
        string partitionId,
        string companyId,
        string originId,
        ...
        DateTimeOffset? birthDate = null)
    {
        ...
        ArgumentException.ThrowIfNullOrEmpty(customer.SalesInvoiceAccount);
        ArgumentException.ThrowIfNullOrEmpty(customer.OrganizationName);
        SalesInvoiceRegistered registered = new(
            partitionId,
            companyId,
            originId,
            customerId,
    ...
    /// <returns>SalesInvoiceV3.</returns>
    /// <exception cref="System.ArgumentNullException">null.</exception>
    public static SalesInvoiceV3 ToDynamics365FinanceSalesInvoice(
        [NotNull] this SalesInvoiceRegistered customerRegistered,
        string? customerAccount = null)
    {
        ArgumentNullException.ThrowIfNull(customerRegistered);
        SalesInvoiceV3 customerV3 = new(customerRegistered.CompanyId)
        {
            SalesInvoiceAccount = customerAccount ?? customerRegistered.Id,
            ...
            SalesInvoiceGroupId = customerRegistered.GroupId,
    ...
    /// <exception cref="System.ArgumentNullException">null.</exception>
    public static SalesInvoiceV3 ToDynamics365FinanceSalesInvoice(
        [NotNull] this SalesInvoiceInformationChanged customerChanged,
        string? customerAccount = null)
    {
        ArgumentNullException.ThrowIfNull(customerChanged);
        SalesInvoiceV3 customerV3 = new(customerChanged.CompanyId)
        {
            SalesInvoiceAccount = customerAccount ?? customerChanged.Id,
            ...
            SalesInvoiceGroupId = customerChanged.GroupId,
    ...
    /// <returns>Hexalith.Infrastructure.Dynamics365Finance.Sales.SalesInvoices.Entities.SalesInvoiceV3Create.</returns>
    public static SalesInvoiceV3Create ToDynamics365FinanceSalesInvoiceCreate(
                [NotNull] this SalesInvoiceRegistered customerRegistered,
                string? nameAlias = null,
                SalesInvoiceV3? template = null)
    {
        ArgumentNullException.ThrowIfNull(customerRegistered);
        SalesInvoiceV3Create customerV3 = new()
        {
            ...
            PrimaryContactPhoneIsMobile = customerRegistered.Contact?.Mobile == null ? "No" : "Yes",
            PrimaryContactEmail = customerRegistered.Contact?.Email,
            SalesInvoiceGroupId = string.IsNullOrWhiteSpace(customerRegistered.GroupId) ? template?.SalesInvoiceGroupId : customerRegistered.GroupId,
    ...
    /// <param name="birthDate">The birth date.</param>
    /// <returns>Hexalith.Application.Sales.Commands.ChangeSalesInvoiceInformation.</returns>
    public static RegisterOrChangeSalesInvoice ToRegisterOrChangeSalesInvoiceCommand(
            [NotNull] this SalesInvoiceV3 customer,
            string partitionId,
            string companyId,
            string originId,
            ...
            DateTimeOffset? birthDate = null)
    {
        ...
        ArgumentException.ThrowIfNullOrEmpty(customer.SalesInvoiceAccount);
        ArgumentException.ThrowIfNullOrEmpty(customer.OrganizationName);
        RegisterOrChangeSalesInvoice changed = new(
            partitionId,
            companyId,
            originId,
            customerId,
