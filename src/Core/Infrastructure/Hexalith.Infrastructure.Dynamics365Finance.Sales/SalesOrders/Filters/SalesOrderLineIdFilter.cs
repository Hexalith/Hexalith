// <copyright file="SalesOrderLineIdFilter.cs" company="Fiveforty SAS Paris France">
...
[DataContract]
public record SalesOrderLineIdFilter(
    string? DataAreaId,
    [property: DataMember(Order = 2)] string? SalesOrderNumber,
    [property: DataMember(Order = 3)] decimal LineNumber)
