...
// ***********************************************************************
// <copyright file="AggregateExternalReferenceSettings.cs" company="Fiveforty SAS Paris France">
...
public class AggregateExternalReferenceSettings : ISettings
{
    /// <summary>
    ...
    public static string ConfigurationName() => nameof(AggregateExternalReference);
}