...
// ***********************************************************************
// <copyright file="SemanticBotAdapter.cs" company="Fiveforty SAS Paris France">
...
public partial class SemanticBotAdapter : CloudAdapter
{
    /// <summary>
    /// Initializes a new instance of the <see cref="SemanticBotAdapter"/> class.
    /// </summary>
    /// <param name="auth">The authentication.</param>
    /// <param name="logger">The logger.</param>
    public SemanticBotAdapter(BotFrameworkAuthentication auth, ILogger<SemanticBotAdapter> logger)
        : base(auth, logger)
    {
