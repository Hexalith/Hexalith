// <copyright file="IServerApplication.cs" company="Fiveforty SAS Paris France">
...
/// </summary>
public interface IServerApplication : IApplicationDefinition
{
    /// <summary>
    /// Gets the client application associated with the server application.
    /// </summary>
