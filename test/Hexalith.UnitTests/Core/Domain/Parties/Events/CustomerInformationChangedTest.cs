...
// ***********************************************************************
// <copyright file="CustomerRegisteredTest____.cs" company="Fiveforty SAS Paris France">
...
public class CustomerInformationChangedTest : PolymorphicSerializationTestBase<CustomerInformationChanged, BaseEvent>
{
    /// <summary>
    ...
    {
        CustomerInformationChanged e = ToSerializeObject() as CustomerInformationChanged;
