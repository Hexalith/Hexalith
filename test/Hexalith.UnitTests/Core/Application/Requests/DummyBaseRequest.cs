// <copyright file="DummyBaseRequest.cs" company="Fiveforty SAS Paris France">
...
{
    protected DummyBaseRequest() => BaseValue = string.Empty;

    [JsonConstructor]
    protected DummyBaseRequest(string baseValue) => BaseValue = baseValue;
